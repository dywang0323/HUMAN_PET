...
class Ontology:
    ...
    def prune( self, goid ):
        ...
        try:
            ...
            print("This term is not in the obo file as primary ID")
...
def get_args( ):
    ...
    parser.add_argument( "--prune-list",
                         default=None,
                         metavar="<path>",
                         help="trimming option: only terms descending from the list terms (GO id) from this file" )
...
def main( ):
	...
	# YC pruning cut for list of terms
    if args.prune_list is not None:
        with open(args.prune_list, "r") as file:
